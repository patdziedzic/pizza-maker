...
/**
 * This class defines a Mediterranean Pizza.
...
public class Mediterranean extends Pizza
{
     ...
     * and toppings) of a Mediterranean pizza
     */
    public Mediterranean()
    {
        sauce = Sauce.ALFREDO;
        toppings = new ArrayList<>(Arrays.asList(Topping.BLACK_OLIVE, Topping.SHRIMP,
                Topping.CRAB_MEATS, Topping.BASIL));
    }

    /**
     * Overridden method which calculates and returns the price of a Mediterranean pizza
